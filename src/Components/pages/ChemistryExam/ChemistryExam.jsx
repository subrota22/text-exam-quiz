...
const ChemistryExam = () => {
    ...
    React.useEffect(() => {
        fetch(`https://test-exam-omega.vercel.app/chemistry-quiz?page=${page}&size=${pageSize}`)
            .then(res => res.json())
            .then(data => {
                setData(data?.data);
                setCount(data?.count);
    ...
    //
    React.useEffect(() => {
        fetch(`https://test-exam-omega.vercel.app/chemistry-quiz-all`)
            .then(res => res.json())
            .then(data => {
                setModalData(data);
            })
    ...
    return (
        <>
            <Helmet> <title>Chemistry exam test</title></Helmet>
