...
const PhysicsExam = () => {
    ...
    React.useEffect(() => {
        fetch(`https://test-exam-omega.vercel.app/physics-quiz?page=${page}&size=${pageSize}`)
            .then(res => res.json())
            .then(data => {
                setData(data?.data);
                setCount(data?.count);
    ...
    //
    React.useEffect(() => {
        fetch(`https://test-exam-omega.vercel.app/physics-quiz-all`)
            .then(res => res.json())
            .then(data => {
                setModalData(data);
            })
    ...
    return (
        <>
            <Helmet> <title>Physics exam test</title></Helmet>
